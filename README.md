...
# 六、实验结果：
### 实验结果一图片：
![img](https://github.com/ChenJian-Jia/Java_experiment_three/blob/main/img/%E8%AE%A1191%20%E8%B4%BE%E5%BF%B1%E5%81%A5%202019310177%20experiment_three%20_picture_result_1.png)
### 实验结果二图片：
![img](https://github.com/ChenJian-Jia/Java_experiment_three/blob/main/img/%E8%AE%A1191%20%E8%B4%BE%E5%BF%B1%E5%81%A5%202019310177%20experiment_three%20_picture_result_2.png)
# 七、实验感想：
### 这次实验的难度是比较大的，我从图书馆借了本Java的书，看了继承类的代码怎么写，我建立了一个包，下面建立了五个类，其中一个父类两个子类，学习到了继承方法的使用。初步了解了分析系统需求，从学生选课角度了解系统中的实体及其关系，学会了定义类中的属性以及方法；掌握了面向对象的类设计方法（属性、方法）；掌握使用toString（）方法，在自定义的类中覆盖Object的toString方法，使其可以输出类的信息。
